    ...
    <>
      ...
      <header className="site-header">
        <div className="site-container flex min-h-[4.5rem] items-center justify-between gap-4 py-3">
          <a href={siteConfig.links.home} aria-label="Plonbli — strona główna" className="flex shrink-0 items-center gap-3">
            <img
        ...
        {open ? (
          <nav id="mobile-navigation" aria-label="Nawigacja mobilna" className="mobile-navigation lg:hidden">
